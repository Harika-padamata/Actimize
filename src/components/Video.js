...
function Vedio() {
  return (
    <div>
        ...
        <video className='videocontent' style ={{margin:"auto",position:"absolute",zIndex:"-1",top:"50%",left:"0%",visibility:"visivle",opacity:"1",width:"auto",height:"809.766px",transform:"translate(0%, -50%)",objectFit:"cover"}} loop={true} autoPlay muted >
