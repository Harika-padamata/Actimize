    ...
    <div>
         <div style={{position:"relative",zIndex:'0',paddingTop:"200px",paddingBottom:"200px"}}>
            <div style={{
                ...
                {matches ?<img className='star' src='https://www.persistent.com/wp-content/uploads/2020/09/ISG-Awards-Background-scaled.jpg' style ={{margin:"auto",position:"absolute",zIndex:"-1",top:"50%",left:"0%",visibility:"visivle",opacity:"1",width:"140%",height:"100%",transform:"translate(0%, -50%)"}}></img>:
                <img className='star' src='https://www.persistent.com/wp-content/uploads/2020/09/ISG-Awards-Background-scaled.jpg' style ={{margin:"auto",position:"absolute",zIndex:"-1",top:"50%",left:"0%",visibility:"visivle",opacity:"1",width:"100%",height:"100%",transform:"translate(0%, -50%)"}}></img>}
