    ...
    <div>
         <div style={{position:"relative",zIndex:'0',paddingTop:"200px",paddingBottom:"200px"}}>
            <div style={{
                ...
                <img src='https://www.zaptechsolutions.com/wp-content/uploads/2016/08/zaptech-banner.jpg' style ={{margin:"auto",position:"absolute",zIndex:"-1",top:"50%",left:"0%",visibility:"visivle",opacity:"1",width:"100%",height:"100%",transform:"translate(0%, -50%)"}}></img>
